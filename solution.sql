...
-- The bank is giving a new customer bonus! Update all records with an account balance
...
INSERT INTO syntax_practice
	VALUES ('9','susie','detroit','42','59','567.92');
-- The bank is losing money in Miami and Phoenix and needs to unload low transaction
-- customers: Delete users that reside in miami OR phoenix and have completed fewer than 5 transactions.DELETE FROM syntax_practice
DELETE FROM syntax_practice
  WHERE (city = 'chicago' OR city = 'minneapolis')
